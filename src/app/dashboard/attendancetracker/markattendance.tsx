  ...
  return (
    <>
      ...
      <label
        ...
        className="btn bg-green-50 hover:bg-blue-50 shadow-md font-semibold rounded-lg"
      >
        Mark Attendance
      </label>
      ...
      <div className="modal" role="dialog">
        <div className="modal-box w-11/12 max-w-3xl">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <input
              type="text"
              placeholder="Work Hours (auto-calculated)"
              readOnly
              value={workhr}
              className="input input-bordered w-full shadow-md p-3 rounded-2xl"
            />
          ...
          <div className="modal-action">
            <label
              htmlFor="attendance_modal"
              className="btn rounded-md bg-blue-200 hover:bg-green-100 shadow-md font-semibold"
            >
              Cancel
            </label>
          </div>
